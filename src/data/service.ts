...
export const serviceList8 = [
    ...
    title: 'DevOps',
    description: `Skilled DevOps professional bridging development and operations, delivering secure solutions through infrastructure management and continuous improvement.`
  },
  {
    id: 2,
    Icon: SettingsThree,
    title: 'Database',
    description: `Dedicated database management specialist with 10 years of experience ensuring complete organization and security. Committed to driving continuous improvement with technology.`
  },
  {
    id: 3,
    Icon: SettingsThree,
    title: 'Full Stak Developer',
    description: `Committed Full Stack developer with 12 years of experience, providing top-notch services for efficient and secure server-side systems.`
  },
  {
    id: 4,
    title: 'Misc',
    Icon: CloudComputing,
    description: `A tech-savvy individual, bringing their expertise in Hackintosh, Raspberry Pi, home automation, and Home Assistant to the personal projects they manage with creativity and a drive for fun.`
  }
];
