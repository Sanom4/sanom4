          ...
          <div className="card-body p-12 pb-0">
            <div className="row">
              <div className="col-lg-4 pb-12 align-self-center">
                ...
                <p>
                  10 years of IT professional responsible for IT infrastructure and website project management,
                  including business requirements, technical specifications, data access tools, and security measures.
                  Collaborated with Ministry of Education on successful initiative.
                </p>
              ...
              <div className="col-lg-7 offset-lg-1 align-self-end">
                <figure>
                  <img className="img-fluid" src="/img/f1.png" srcSet="/img/f1.png 2x" alt="" />
                </figure>
              </div>
            </div>
          </div>
          ...
          <div className="card-body p-12">
            <div className="row gy-10 align-items-center">
              <div className="col-lg-4 order-lg-2 offset-lg-1">
                ...
                <p>
                  2 years of experience as a developer in a publishing organization, with a focus on front-end and
                  back-end development. Have created interfaces for advertising materials using PHP, MySQL, and
                  Bootstrap. They have also designed databases for e-commerce projects and have experience in database
                  design and architecture, and have managed SEO and optimized search results, as seen with their ranking
                  for "Savizito Barati" in Georgia.
                </p>
              ...
              <div className="col-lg-7">
                <figure>
                  <img className="img-fluid" src="/img/f2.png" srcSet="/img/f2.png 2x" alt="" />
                </figure>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-6">
            <div className="card bg-soft-leaf mb-10">
              <div className="card-body p-12 pb-0">
                ...
                <p>
                  Collaborative Photography based platform for public photo sharing, private sharing, and giving access
                  to a photographers to do same within their communities.
                </p>
                <NextLink title="See Info" href="/projects/vmomentum" className="more hover link-leaf mb-8" />
              </div>

              <img className="card-img-bottom" src="/img/f3.png" srcSet="/img/f3.png 2x" alt="" />
            </div>
          </div>
          ...
          <div className="col-lg-6">
            <div className="card bg-soft-pink">
              <div className="card-body p-12 pb-0">
                ...
                <p>
                  With a deep understanding of web frameworks and content management systems, you bring expertise to the
                  table in platforms like Laravel, Nette, CodeIgniter, WordPress, React.js, Next.js, and Tailwind,
              ...
              <img className="card-img-bottom" src="/img/f4.png" srcSet="/img/f4.png 2x" alt="" />
            </div>
          </div>
        </div>
      </div>
